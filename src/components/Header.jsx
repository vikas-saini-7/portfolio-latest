  ...
  return (
    <>
        ...
        <div className='md:hidden'>
            ...
            >
                <div className='p-8'>
                    <div onClick={toggleDrawer} className='mb-12 p-2 rounded hover:bg-gray-200 cursor-pointer w-fit'>
                        <IconX className=''/>
                    </div>
                    <ul className='flex flex-col gap-4 font-semibold text-2xl'>
                        <a onClick={toggleDrawer} href="./" className='hover:text-blue-600 transition-all'><li>Home</li></a>
                        <a onClick={toggleDrawer} href="#about" className='hover:text-blue-600 transition-all'><li>About</li></a>
                        <a onClick={toggleDrawer} href="#projects" className='hover:text-blue-600 transition-all'><li>Projects</li></a>
                        <a onClick={toggleDrawer} href="#contact" className='hover:text-blue-600 transition-all'><li>Contact</li></a>
                    </ul>
                </div>
            </Drawer>
        </div>
